...
# Github repo
issues_github_path = "fvutils/mkdv"
...
latex_documents = [
  ('index', 'mkdv.tex', u'MkDV Documentation',
...
man_pages = [
    ('index', 'mkdv', u'MkDV Documentation',
...
texinfo_documents = [
  ('index', 'mkdv', u'MkDV Documentation',
   u'Matthew Ballance and Contributors', 'MkDV', 'MkDV Job Runner for Design and Verification',
   'Miscellaneous'),
]
...
#breathe_projects = { "mkdv": "doxygen/_xml" }
#breathe_default_project = "mkdv"
